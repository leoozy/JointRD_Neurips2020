...
from model.diraconv import DiracConv2d
from model.immiconv import ImmiConv2d
inplace = False
affine = True

SkipConv2d = DiracConv2d
...
class ResNet(nn.Module):
    def __init__(self, block, blockwoskip, layers_blocks, blockchoice, num_classes=1000, mul=1.0):
